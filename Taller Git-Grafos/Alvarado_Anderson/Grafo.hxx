...
//Algoritmo de Prim
template <class T>
float Grafo<T>::prim(vector<int>* distancias, vector<T> *S,T dato){
...
template <class T>
Vertice<T> Grafo<T>::mindistance(list<Vertice<T> >* todosLosVertices, vector<int> distancias)
{
...
template <class T>
float Grafo<T>::recorridoDijkstra(vector<int>* distancias, vector<Vertice<T> >* prede, vector<T> *S, T dato)
{
    float suma = 0;
